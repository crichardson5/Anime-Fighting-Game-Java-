...
public class JavaDrawingPanel extends Thread
     ...
     *
     * @author Dr. Wayne Brown <Wayne.Brown@usafa.edu> - edited by Caleb Richardson
    ...
    private MyDrawingCanvas canvas;            // drawing canvas for window (inside panel)
     ...
     */
    public JavaDrawingPanel(int desiredWidth, int desiredHeight) {
    ...
    public void run() {
        ...
        canvas = new MyDrawingCanvas(this);
     ...
     */
    public void setBackground(Color c, int backWidth, int backHeight) {
        ...
        offscreenGraphics.fillRect(0, 0, backWidth, backHeight);
     ...
     *
     * <p>
     * ger values represents the key that was pressed (and not the
    ...
    private String getKeyString(int code) {
        ...
        if ((code >= 'A' && code <= 'Z') || (code >= '0' && code <= '9')) {
            ...
            str = "F" + (code - F1_KEY + 1);
        } else if (code == JavaDrawingPanel.LEFT_ARROW_KEY) {
            str = "left";
        } else if (code == JavaDrawingPanel.RIGHT_ARROW_KEY) {
            str = "right";
        } else if (code == JavaDrawingPanel.UP_ARROW_KEY) {
            str = "up";
        } else if (code == JavaDrawingPanel.DOWN_ARROW_KEY) {
            str = "down";
        } else if (code == JavaDrawingPanel.INSERT_KEY) {
            str = "insert";
        } else if (code == JavaDrawingPanel.HOME_KEY) {
            str = "home";
        } else if (code == JavaDrawingPanel.DELETE_KEY) {
            str = "del";
        } else if (code == JavaDrawingPanel.END_KEY) {
            str = "end";
        } else if (code == JavaDrawingPanel.PAGE_UP_KEY) {
            str = "page_up";
        } else if (code == JavaDrawingPanel.PAGE_DOWN_KEY) {
            str = "page_down";
        } else if (code == JavaDrawingPanel.ESC_KEY) {
            str = "esc";
        } else if (code == JavaDrawingPanel.TAB_KEY) {
            str = "tab";
        } else if (code == JavaDrawingPanel.SHIFT_KEY) {
            str = "shift";
        } else if (code == JavaDrawingPanel.ENTER_KEY) {
            str = "enter";
        } else if (code == JavaDrawingPanel.SPACE_KEY) {
            str = "space";
        } else {
            str = "error";
        }
    ...
    class MyDrawingCanvas extends Canvas {
        ...
        // -------------------------------------------------------------------
        private JavaDrawingPanel panel;

        // -------------------------------------------------------------------
        public MyDrawingCanvas(JavaDrawingPanel thisPanel) {
            super();
            panel = thisPanel;
        }
